...
Begin VB.Form Receiving_Order 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "                                           -----  Receiving Order -----"
   ClientHeight    =   5880
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11385
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Party 
         ...
         Width           =   3495
      End
      Begin MSComCtl2.DTPicker InputDate 
         Height          =   300
         Left            =   480
         TabIndex        =   1
         Top             =   600
   ...
   Begin VB.Frame Frame4 
      ...
      Begin LVbuttons.LaVolpeButton Cmdhide 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "Receiving_Order.frx":0000
         ALIGN           =   1
         IMGLST          =   "(None)"
         IMGICON         =   "7"
         ICONAlign       =   0
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receiving_Order.frx":001C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receiving_Order.frx":0284
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receiving_Order.frx":06DC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receiving_Order.frx":0AF8
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receiving_Order.frx":0F2C
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receiving_Order.frx":134C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receiving_Order.frx":1788
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin LVbuttons.LaVolpeButton CmdAllSearch 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Receiving_Order.frx":181C
      ALIGN           =   1
      IMGLST          =   "ImageList1"
      IMGICON         =   "5"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton cmdClose 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Receiving_Order.frx":1838
      ALIGN           =   1
      IMGLST          =   "ImageList1"
      IMGICON         =   "6"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton CmdDel 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Receiving_Order.frx":1854
      ALIGN           =   1
      IMGLST          =   "ImageList1"
      IMGICON         =   "4"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton CmdNew 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Receiving_Order.frx":1870
      ALIGN           =   1
      IMGLST          =   "ImageList1"
      IMGICON         =   "3"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton cmdSave 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Receiving_Order.frx":188C
      ALIGN           =   1
      IMGLST          =   "ImageList1"
      IMGICON         =   "2"
      ICONAlign       =   0
   ...
   Begin LVbuttons.LaVolpeButton CMDdetail 
      ...
      EMBOSSS         =   16777215
      MPTR            =   0
      MICON           =   "Receiving_Order.frx":18A8
      ALIGN           =   1
      IMGLST          =   "ImageList1"
      IMGICON         =   "1"
      ICONAlign       =   0
   ...
   End
End
Attribute VB_Name = "Receiving_Order"
...
Private Sub CmdAllSearch_Click()
        Receiving_Order.Left = 200
        Receiving_Order.Top = 500
        Receiving_Order.Width = 11500
...
Private Sub CmdDel_Click()
    If (Len(Trim(m_ListID)) > 0 And Len(Trim(d_ListID)) > 0) Then
        ...
        If strAns = vbYes Then
            cnDatabase.Execute "update ReceiveOrderDetail set IsActive = 0 where DetailInputCode =" & d_ListID
            Call fillList
...
If Len(Trim(Party)) > 0 And Len(Trim(Challan)) > 0 And Len(Trim(Item_Type)) > 0 And Len(Trim(Item)) > 0 And Len(Trim(Qty)) > 0 And Len(Trim(Rates)) > 0 Then
            a = Me.Item.ItemData(Me.Item.ListIndex)
            Set rs = FillRecordSet("select Qty, AvgCost from vwAvailableQty where ItemCode = " & a)
            If Not rs.EOF Then
                Curr_Qty = rs("qty")
                Curr_Avg = rs("avgCost")
            End If
            ...
            If Curr_Qty < 0 Then
                Curr_Qty = 1
            End If
            New_Qty = CDbl(Qty.Text) + Curr_Qty
            New_Avg = (((CDbl(Qty.Text) * CDbl(Rates.Text)) + (Curr_Qty * Curr_Avg)) / New_Qty)
...
Private Sub Item_Type_Click()
    If (Me.Item_Type.ListIndex > -1) Then
        ...
        FillCombo "Select ItemCode, ItemName from Item where IsActive = 1 and ItemTypeCode = " & i, Item, "ItemName", "ItemCode"
    Else
        Me.Item.Clear
    End If
End Sub
...
Private Sub getValMaster()
    ...
    Set rstGetVal = FillRecordSet("Select MasterInputCode, MasterInputDate, PartyCode, ChallanCode From ReceiveOrderMaster Where MasterInputCode = " & m_ListID)
    If Not (rstGetVal.EOF) Then
        Me.InputDate.value = IIf(IsNull(rstGetVal("MasterInputDate")), Now, rstGetVal("MasterInputDate"))
...
Private Sub getValDetail()
    Dim rstGetVal As New ADODB.Recordset
    Set rstGetVal = FillRecordSet("Select ItemTypeCode, ItemCode, Quantity, Rate From ReceiveOrderDetail Where DetailInputCode = " & d_ListID)
    If Not (rstGetVal.EOF) Then
...
Public Sub setValMaster()
    ...
    If (Len(Trim(m_ListID)) = 0) Then
        Set rstSave = FillRecordSet("select * from ReceiveOrderMaster Where 1 = 2")
        rstSave.AddNew
        m_ListID = ValAutoNumber("ReceiveOrderMaster", "MasterInputCode")
        rstSave("MasterInputCode") = m_ListID
    Else
       Set rstSave = FillRecordSet("select * from ReceiveOrderMaster where MasterInputCode =" & m_ListID)
    End If
    
    rstSave("MasterInputDate") = Me.InputDate.value
...
Public Sub setValDetail()
    ...
    If (Len(Trim(d_ListID)) = 0) Then
        Set rstSave = FillRecordSet("select * from ReceiveOrderDetail Where 1 = 2")
        rstSave.AddNew
        d_ListID = ValAutoNumber("ReceiveOrderDetail", "DetailInputCode")
        rstSave("DetailInputCode") = d_ListID
    Else
       Set rstSave = FillRecordSet("select * from ReceiveOrderDetail where DetailInputCode =" & d_ListID)
    End If
...
Private Sub fillList()
    ...
    Set rstList = FillRecordSet("SELECT top 60 DetailInputCode, ReceiveOrderMaster.MasterInputCode, PartyName, ReceiveOrderMaster.PartyCode, ReceiveOrderDetail.ItemTypeCode, ItemTypeName, ReceiveOrderDetail.ItemCode, ItemName, Quantity, Rate " & _
                                "FROM (Party INNER JOIN (ReceiveOrderMaster INNER JOIN ReceiveOrderDetail ON ReceiveOrderMaster.MasterInputCode = ReceiveOrderDetail.MasterInputCode) ON Party.PartyCode = ReceiveOrderMaster.PartyCode) INNER JOIN (ItemType INNER JOIN Item ON ItemType.ItemTypeCode = Item.ItemTypeCode) ON (ReceiveOrderDetail.ItemCode = Item.ItemCode) AND (ReceiveOrderDetail.ItemTypeCode = ItemType.ItemTypeCode) " & _
                                "Where ReceiveOrderDetail.IsActive = 1 order by ReceiveOrderMaster.MasterInputCode desc, DetailInputCode desc")
    lvwphase.ListItems.Clear
    If Not rstList.EOF Then
      Do While Not rstList.EOF
            Set lstItem = lvwphase.ListItems.Add( _
                   Text:=rstList!DetailInputCode, _
                   Key:=CStr("Id=" & rstList!DetailInputCode))
            With lstItem.ListSubItems
                 .Add Text:=rstList!MasterInputCode
...
Private Sub SrfillList()
    ...
    If dtChk.value = Checked Then
        'srdt = " And (MasterInputDate between #" & Me.SrDate.value & " #  and #" & Me.SrDate2.value + 1 & " #)"
        srdt = " And (MasterInputDate between Convert(datetime, '" & Me.SrDate.value - 1 & "')  and Convert(datetime, '" & Me.SrDate2.value + 1 & "'))"
    Else
        srdt = ""
    End If
    
    If PtChk.value = Checked And Me.srParty.ListIndex > -1 Then
        cbo1 = " And ReceiveOrderMaster.partycode = " & Me.srParty.ItemData(Me.srParty.ListIndex)
    Else
        cbo1 = ""
    End If
    
    If ImTChk.value = Checked And Me.SrItemType.ListIndex > -1 Then
        cbo2 = " And ReceiveOrderDetail.ItemTypeCode = " & Me.SrItemType.ItemData(Me.SrItemType.ListIndex)
    Else
        cbo2 = ""
    End If
    
    If ImChk.value = Checked And Me.SrItem.ListIndex > -1 Then
        cbo3 = " And ReceiveOrderDetail.ItemCode = " & Me.SrItem.ItemData(Me.SrItem.ListIndex)
    Else
        cbo3 = ""
    End If
    
    sql = " SELECT top 60 DetailInputCode, ReceiveOrderMaster.MasterInputCode, PartyName, ReceiveOrderMaster.PartyCode, ReceiveOrderDetail.ItemTypeCode, ItemTypeName, ReceiveOrderDetail.ItemCode, ItemName, Quantity, Rate " & _
          " FROM (Party INNER JOIN (ReceiveOrderMaster INNER JOIN ReceiveOrderDetail ON ReceiveOrderMaster.MasterInputCode = ReceiveOrderDetail.MasterInputCode) ON Party.PartyCode = ReceiveOrderMaster.PartyCode) INNER JOIN (ItemType INNER JOIN Item ON ItemType.ItemTypeCode = Item.ItemTypeCode) ON (ReceiveOrderDetail.ItemCode = Item.ItemCode) AND (ReceiveOrderDetail.ItemTypeCode = ItemType.ItemTypeCode) " & _
          " Where ReceiveOrderDetail.IsActive = 1 " & _
          srdt & _
          cbo1 & _
          cbo2 & _
          cbo3 & _
          " Order by ReceiveOrderMaster.MasterInputCode desc, DetailInputCode desc"

...
Begin VB.Form RepItemProduction 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RepItemProduction.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RepItemProduction.frx":0278
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin LVbuttons.LaVolpeButton cmdCancel 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "RepItemProduction.frx":0310
         ALIGN           =   1
         IMGLST          =   "ImageList1"
         IMGICON         =   "2"
         ICONAlign       =   0
      ...
      Begin LVbuttons.LaVolpeButton cmdReport 
         ...
         EMBOSSS         =   16777215
         MPTR            =   0
         MICON           =   "RepItemProduction.frx":032C
         ALIGN           =   1
         IMGLST          =   "ImageList1"
         IMGICON         =   "1"
         ICONAlign       =   0
   ...
   End
End
Attribute VB_Name = "RepItemProduction"
...
Dim rstGetVal As New ADODB.Recordset
        ...
        selcformula = "{Delivery.ItemTypeCode}=" & Me.ItemType.ItemData(Me.ItemType.ListIndex) & " and {Delivery.ItemCode}=" & Me.Item.ItemData(Me.Item.ListIndex) & " and {Delivery.DeliveryMasterDate} >= #" & Format(dt1, "dd-mmm-yy") & "#  and {Delivery.DeliveryMasterDate} <= #" & Format(dt2, "dd-mmm-yy") & "#  "

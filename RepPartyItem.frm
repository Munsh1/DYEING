...
Begin VB.Form RepPartyItem 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RepPartyItem.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RepPartyItem.frx":0278
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "RepPartyItem"
...
Dim rstGetVal As New ADODB.Recordset
   If Me.Party.ListIndex > -1 And Me.ItemType.ListIndex > -1 And Me.Item.ListIndex > -1 Then
        crptDaily.ReportFileName = App.Path & "\Reports\Party_Item.rpt"
        crptDaily.Connect = conStr
        selcformula = "{ItemReport.ItemCode}=" & Me.Item.ItemData(Me.Item.ListIndex) & " and {ItemReport.PartyCode}=" & Me.Party.ItemData(Me.Party.ListIndex)
        
        vItemName = getItemName(Me.Item.ItemData(Me.Item.ListIndex))
        vPartyName = getPartyName(Me.Party.ItemData(Me.Party.ListIndex))
       
        crptDaily.Formulas(0) = "ItemHeading ='" & vItemName & "'"
        crptDaily.Formulas(1) = "PartyHeading ='" & vPartyName & "'"
...
Private Sub Form_Load()
    ...
    FillCombo "Select PartyCode, PartyName from Party where IsActive = 1 order by PartyName", Party, "PartyName", "PartyCode"
End Sub

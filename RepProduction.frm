...
Begin VB.Form RepProduction 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RepProduction.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RepProduction.frx":0278
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "RepProduction"
...
Dim rstGetVal As New ADODB.Recordset
        ...
        selcformula = "{Delivery.ItemTypeCode}=" & Me.ItemType.ItemData(Me.ItemType.ListIndex) & " and {Delivery.DeliveryMasterDate} >= #" & Format(dt1, "dd-mmm-yy") & "#  and {Delivery.DeliveryMasterDate} <= #" & Format(dt2, "dd-mmm-yy") & "#  "

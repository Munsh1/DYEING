   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receivings.frx":001C
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receivings.frx":0284
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receivings.frx":06DC
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receivings.frx":0AF8
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receivings.frx":0F2C
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receivings.frx":134C
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Receivings.frx":1788
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub CmdDel_Click()
    If (Len(Trim(m_ListID)) > 0 And Len(Trim(d_ListID)) > 0) Then
        ...
        If strAns = vbYes Then
            cnDatabase.Execute "update DetailInput set IsActive = 0 where DetailInputCode =" & d_ListID
            Call fillList
...
'            cnDatabase.Execute ("update Item set AvgCost = " & New_Avg & " where itemCode = " & a)
...
Private Sub getValMaster()
    ...
    Set rstGetVal = FillRecordSet("Select MasterInputCode, MasterInputDate, PartyCode, ChallanCode From MasterInput Where MasterInputCode = " & m_ListID)
...
Private Sub getValDetail()
    Dim rstGetVal As New ADODB.Recordset
    Set rstGetVal = FillRecordSet("Select ItemTypeCode, ItemCode, Quantity, Rate From DetailInput Where DetailInputCode = " & d_ListID)
    If Not (rstGetVal.EOF) Then
...
Public Sub setValMaster()
    ...
    If (Len(Trim(m_ListID)) = 0) Then
        Set rstSave = FillRecordSet("select * from MasterInput Where 1 = 2")
        rstSave.AddNew
        m_ListID = ValAutoNumber("MasterInput", "MasterInputCode")
        rstSave("MasterInputCode") = m_ListID
    Else
       Set rstSave = FillRecordSet("select * from MasterInput where MasterInputCode =" & m_ListID)
    End If
...
Public Sub setValDetail()
    ...
    If (Len(Trim(d_ListID)) = 0) Then
        Set rstSave = FillRecordSet("select * from DetailInput Where 1 = 2")
        rstSave.AddNew
        d_ListID = ValAutoNumber("DetailInput", "DetailInputCode")
        rstSave("DetailInputCode") = d_ListID
    Else
       Set rstSave = FillRecordSet("select * from DetailInput where DetailInputCode =" & d_ListID)
    End If
...
Private Sub fillList()
    ...
    Set rstList = FillRecordSet("SELECT top 60 DetailInputCode, MasterInput.MasterInputCode, PartyName, MasterInput.PartyCode, DetailInput.ItemTypeCode, ItemTypeName, DetailInput.ItemCode, ItemName, Quantity, Rate " & _
                                "FROM (Party INNER JOIN (MasterInput INNER JOIN DetailInput ON MasterInput.MasterInputCode = DetailInput.MasterInputCode) ON Party.PartyCode = MasterInput.PartyCode) INNER JOIN (ItemType INNER JOIN Item ON ItemType.ItemTypeCode = Item.ItemTypeCode) ON (DetailInput.ItemCode = Item.ItemCode) AND (DetailInput.ItemTypeCode = ItemType.ItemTypeCode) " & _
                                "Where DetailInput.IsActive = 1 order by MasterInput.MasterInputCode desc, DetailInputCode desc")
...
Private Sub SrfillList()
    ...
    If PtChk.value = Checked And Me.srParty.ListIndex > -1 Then
        cbo1 = " And masterinput.partycode = " & Me.srParty.ItemData(Me.srParty.ListIndex)
    Else
        cbo1 = ""
    End If
    
    If ImTChk.value = Checked And Me.SrItemType.ListIndex > -1 Then
        cbo2 = " And DetailInput.ItemTypeCode = " & Me.SrItemType.ItemData(Me.SrItemType.ListIndex)
    Else
        cbo2 = ""
    End If
    
    If ImChk.value = Checked And Me.SrItem.ListIndex > -1 Then
        cbo3 = " And DetailInput.ItemCode = " & Me.SrItem.ItemData(Me.SrItem.ListIndex)
    Else
        cbo3 = ""
    End If
    
    sql = " SELECT top 60 DetailInputCode, MasterInput.MasterInputCode, PartyName, MasterInput.PartyCode, DetailInput.ItemTypeCode, ItemTypeName, DetailInput.ItemCode, ItemName, Quantity, Rate " & _
          " FROM (Party INNER JOIN (MasterInput INNER JOIN DetailInput ON MasterInput.MasterInputCode = DetailInput.MasterInputCode) ON Party.PartyCode = MasterInput.PartyCode) INNER JOIN (ItemType INNER JOIN Item ON ItemType.ItemTypeCode = Item.ItemTypeCode) ON (DetailInput.ItemCode = Item.ItemCode) AND (DetailInput.ItemTypeCode = ItemType.ItemTypeCode) " & _
          " Where DetailInput.IsActive = 1 " & _
          srdt & _
          cbo1 & _
          cbo2 & _
          cbo3 & _
          " Order by MasterInput.MasterInputCode desc, DetailInputCode desc"

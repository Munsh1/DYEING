      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RepDateItem.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RepDateItem.frx":0278
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Dim rstGetVal As New ADODB.Recordset
   If Me.ItemType.ListIndex > -1 And Me.Item.ListIndex > -1 Then
        crptDaily.ReportFileName = App.Path & "\Reports\Date_Item.rpt"
        crptDaily.Connect = conStr
        
        selcformula = "{ItemReport.ItemCode}= " & Me.Item.ItemData(Me.Item.ListIndex) & " and {ItemReport.dt} >= #" & Format(dt1, "dd-mmm-yy") & "#  and {ItemReport.dt} <= #" & Format(dt2, "dd-mmm-yy") & "#  "
